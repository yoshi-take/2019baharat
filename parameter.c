...
/* ============== */
	...
	PRIVATE CONST stGAIN f_StGainData[PARAM_MOVE_SPEED_MAX][PARAM_ST_MAX] = {
		...
		/* 低速(PARAM_SLOW) */
		{	// FF		速度kp		位置kp		位置ki		角速度kp	角度kp		角速度ki	壁kp		壁kd
			{0.07f,		3.0f,		0.0f,		0.0f,		1.0f,		3.5f,		0.2f,		3.0f,		0.0f,	},		// PARAM_ACC		
			{0.0f,		5.0f,		0.0f,		0.0f,		1.0f,		3.5f,		0.2f,		3.0f,		0.0f,	},		// PARAM_CONST
			{0.0f,		2.0f,		1.5f,		0.2f,		1.0f,		3.0f,		0.2f,		3.0f,		0.0f,	},		// PARAM_DEC
