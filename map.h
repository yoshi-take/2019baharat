...
//**************************************************
/*----------------------------------壁情報------------------------------------*/
//	0b(探索済:西)(探索済:南)(探索済:東)(探索済:北)(壁:西)(壁:南)(壁:東)(壁:北)

/*--壁の位置--*/
#define		WALL_NORTH		(0x01)			//北方向
#define		WALL_EAST		(0x02)			//東方向
#define		WALL_SOUTH		(0x04)			//南方向
#define		WALL_WEST		(0x08)			//西方向

/*--壁の探索--*/
#define		DONE_NORTH		(0x10)			//北方向
#define		DONE_EAST		(0x20)			//東方向
#define		DONE_SOUTH	 	(0x40)			//南方向
#define		DONE_WEST	 	(0x80)			//西方向

#define		DONE_ALL 	 	(0xf0)			//全方向
